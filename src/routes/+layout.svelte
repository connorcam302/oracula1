...
<svelte:head>
    <title>Oracula1 - F1 Race Tracker</title>
</svelte:head>
...
<div class="flex h-screen overflow-hidden">
    ...
    <div
        class="fixed inset-y-0 left-0 z-40 md:relative md:flex {mobileOpen
            ...
            : 'hidden md:flex'}"
    >
        <AppSidebar bind:collapsed session={data.session} seasons={data.sidebarSeasons} hasClaimedProfile={data.hasClaimedProfile} />
    </div>
